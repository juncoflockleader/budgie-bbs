...
type CounterStore = handler.CounterStore
type CounterMutation = handler.CounterMutation
type CounterUserIdentity = handler.CounterUserIdentity
type CounterReactionIdentity = handler.CounterReactionIdentity
type CounterPollVoteIdentity = handler.CounterPollVoteIdentity
...
func newHandler(db *sql.DB, bus Bus, counterStore CounterStore, presenceStore PresenceStore, chatStore ChatStore) *Handler {
	...
	handler.SetRuntime(handler.Runtime{
		...
		UpsertDigestEntryTx:          upsertDigestEntryTx,
		RemoveDigestEntry:            removeDigestEntry,
		RemoveDigestEntryTx:          removeDigestEntryTx,
		RemoveDigestEntryFinalTx:     removeDigestEntryFinalTx,
		UpdateDigestEntry:            updateDigestEntry,
		UpdateDigestEntryTx:          updateDigestEntryTx,
		SetDigestEntryBody:           setDigestEntryBody,
		SetDigestEntryBodyTx:         setDigestEntryBodyTx,
		UpsertDigestDirectory:        upsertDigestDirectory,
		UpsertDigestDirectoryTx:      upsertDigestDirectoryTx,
		...
		MoveDigestPathTx:             moveDigestPathTx,
		MoveDigestPathFinalTx:        moveDigestPathFinalTx,
		CopyDigestPath:               copyDigestPath,
		CopyDigestPathTx:             copyDigestPathTx,
		DeleteDigestPath:             deleteDigestPath,
		DeleteDigestPathTx:           deleteDigestPathTx,
		DeleteDigestPathFinalTx:      deleteDigestPathFinalTx,
