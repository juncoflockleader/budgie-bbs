...
const (
	...
	msgStatusCommandQueued      msgKey = "status.commandQueued"
...
var tuiMessages = map[localeCode]map[msgKey]string{
	localeEN: {
		...
		msgStatusCommandQueued:      "command queued",
		...
		msgHelpMainMenu:             "enter/→=open  1-8=jump  p=profile  o=online  q=quit",
	...
	localeZHCN: {
		...
		msgHelpMainMenu:            "enter/→=打开  1-8=跳转  p=资料  o=在线  q=退出",
	...
	localeZHTW: {
		...
		msgHelpMainMenu:            "enter/→=開啟  1-8=跳轉  p=個人資料  o=線上  q=離開",
